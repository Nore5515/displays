...
#define EPD_CS 32    // can be any pin, but required!
...
#define EPD_RESET 27 // can set to -1 and share with chip Reset (can't deep sleep)
...
void loop()
{
  ...
  testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", EPD_WHITE);
  display.display();
